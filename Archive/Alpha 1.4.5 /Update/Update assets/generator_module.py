...
class conv_window:
    ...
    def __init__(self,root,title,version):
        ...
        #
        self.entry8_button = Button(self.filepath_options_frame, text="(Empty)",bg="blue",fg="white",relief=RAISED)#,command=self.update_filepaths)
...
if __name__ =='__main__':   #If executed within same file
    root = Tk()
    conv_window(root, "Generator", " Debug")
else:
    pass
