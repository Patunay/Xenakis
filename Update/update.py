...
Notes on version Alpha 1.3:
    ...
    In the next update:
        -Score Generation:
            ...
            -All previews on same window:
                -Show/Hide on right side
        -Graphic Editor:
            -Figure out:
                -Infinite Canvas
                -Layers
...
class conv_window: 
    ...
    def __init__(self,root,title,version):
        ...
        #Frames
        self.big_frame = LabelFrame(self.root,padx=5,pady=5) 
        self.big_frame.grid(row=0,column=0,padx=10,pady=10,columnspan=2)   

        first_frame = LabelFrame(self.big_frame,text ="1) Set Parameters",padx=5,pady=5)
        first_frame.grid(row=1,column=0,columnspan=2,rowspan=4,padx=10,pady=10)  

        second_frame = LabelFrame(self.big_frame,text ="2) Select Files",padx=5,pady=5)
        second_frame.grid(row=5,column=0,columnspan=2,padx=10,pady=10)   

        third_frame = LabelFrame(self.big_frame,text ="3) Check Voice Order",padx=3,pady=3) 
        third_frame.grid(row=1,column=2,rowspan=3,padx=10,pady=10)  

        fourth_frame = LabelFrame(self.big_frame,text ="4) Start",padx=3,pady=3) 
        fourth_frame.grid(row=5,column=2,rowspan=4,padx=10,pady=10)   

        title_label = Label(self.big_frame, text=title,anchor=CENTER,font="helvetica 18 bold")
        title_label.grid(row=0,column=0,columnspan=3)

        self.preview_frame = Frame(self.root, padx=5,pady=5)
        self.preview_frame.grid(row=0,column=3)
        ...
        self.entry12_button = Button(third_frame, text="Delete Layer",bg="blue",fg="white",relief=RAISED,command= self.delete_path) #####EMPTY
    ...
    def preview_voice(self):
        ...
        # load image
        panel = Label(self.preview_frame, image=image)
        panel.image = image
